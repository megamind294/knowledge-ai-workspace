...
4. **Day 4 — in progress:** normalization/chunking, PDF/TXT/Markdown/DOCX textual extraction, authorized process-local byte storage, pgvector schema, provider-neutral transactional indexing, authenticated indexing/retry UI, and scoped semantic source search; durable storage and final acceptance remain
